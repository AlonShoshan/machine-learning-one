...
class Evolution:
    def __init__(self, usePrints=False, populationSize=20,numOfEvolutionSteps=5,mutationFactor=0.01):
        self.usePrints = usePrints
        self.populationSize = populationSize
        self.evolutionStep = 0
        self.numOfEvolutionSteps = numOfEvolutionSteps
        self.population = pop.population(populationSize=self.populationSize)
    ...
    def run(self):
        ...
        for evStep in range(self.numOfEvolutionSteps):
            ...
            if self.usePrints :
                ...
                print('Best genes in Evolution Step:',self.population.getBestGenes())
