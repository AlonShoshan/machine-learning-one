...
class Evolution:
    def __init__(self, dnaArgs, usePrints=False, populationSize=20,numOfEvolutionSteps=5,mutationFactor=0.01):
        self.usePrints = usePrints
        self.populationSize = populationSize
        self.evolutionStep = 0
        self.numOfEvolutionSteps = numOfEvolutionSteps
        self.population = pop.population(dnaArgs, populationSize=self.populationSize)
